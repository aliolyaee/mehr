...
export const EmailAddress = 'نام کاربری';
...
export const reEnterPassword = "تکرار رمز عبور";
...
// pages
export const RememberPassword = 'به خاطر سپردن رمز عبور';
export const ForgotPassword = 'فراموشی رمز عبور';
export const SignIn = 'ورود';
export const SignUp = 'ایجاد حساب کاربری';
...
export const Account = 'حساب کاربری';
export const Taskboard = 'Taskboard';

export const QuickOption = 'تنظیمات';
