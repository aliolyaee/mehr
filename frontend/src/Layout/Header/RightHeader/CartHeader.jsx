...
const CartHeader = () => {
	...
	const RedirectToCart = () => {
		history(`${process.env.REACT_APP_BASE_PATH}/app/ecommerce/cart/${layout}`);
	};
	return (
			...
			>
				...
				<ul>
					...
					<li className="text-center">
						<Link
							to={`${process.env.REACT_APP_BASE_PATH}/app/ecommerce/cart/${layout}`}
							className="d-block mb-3 view-cart f-w-700"
						>
							{GOTOYOURCART}
						</Link>
						<Link
							to={`${process.env.REACT_APP_BASE_PATH}/app/ecommerce/checkout/${layout}`}
