...
import Mixed from "../../../assets/images/layouts/dubai.jpg";
			...
			<ul className="sidebar-type layout-grid layout-types">
				...
				>
					...
					<div className="layout-img">
						{" "}
						<Media src={Mixed} className="img-fluid" alt="" />
						<H6>Mixed</H6>
					</div>
				</LI>
				<LI
					attrLI={{
						dataattr: "modern-layout",
				...
				<LI
					attrLI={{
						...
						onClick: (e) => handlePageLayputs(classes[4]),
					}}
				>
					<div className="layout-img">
				...
				<LI
					attrLI={{
						dataattr: "compact-wrap",
						onClick: (e) => handlePageLayputs(classes[5]),
					}}
				>
					<div className="layout-img">
				...
				<LI
					attrLI={{
						dataattr: "color-sidebar",
						onClick: (e) => handlePageLayputs(classes[6]),
					}}
				>
					<div className="layout-img">
				...
				<LI
					attrLI={{
						dataattr: "compact-small",
						onClick: (e) => handlePageLayputs(classes[7]),
					}}
				>
					<div className="layout-img">
				...
				<LI
					attrLI={{
						...
						onClick: (e) => handlePageLayputs(classes[8]),
					}}
				>
					<div className="layout-img">
				...
				<LI
					attrLI={{
						dataattr: "enterprice-type",
						onClick: (e) => handlePageLayputs(classes[9]),
					}}
				>
					<div className="layout-img">
				...
				<LI
					attrLI={{
						dataattr: "material-icon",
						onClick: (e) => handlePageLayputs(classes[10]),
					}}
				>
					<div className="layout-img">
				...
				<LI
					attrLI={{
						dataattr: "advance-type",
						onClick: (e) => handlePageLayputs(classes[11]),
					}}
				>
					<div className="layout-img">
				...
				<LI
					attrLI={{
						dataattr: "default-body",
						className: "only-body",
						onClick: (e) => handlePageLayputs(classes[1]),
					}}
					//
				>
					<div className="layout-img">
